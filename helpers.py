...
def processUser(action: str, namespace_action: bool, tenant: str, user: dict) -> bool:
    """Add or remove a user from Volterra Console"""
    return True


def processRequest(action: str, authorization_token: str, name: str, namespace_action: bool, tenant: str) -> bool:
    ...
    if "@" in name:
        ...
        # Process user
        result = processUser(action, namespace_action, tenant, user)
